...
const LaneRender = (props: LaneProps) => {
    const [{ canDrop, isOver }, drop] = useDrop({
        ...
        canDrop: (item, monitor) => {
            ...
            return typedItem.sourceLane._parsedTransitionData.some(
                (p) => p.to === props.lane.option.Value
            );
        },
    });
    ...
    const mapDataToTile = (d: any) => (
        <Tile
            ...
            subscriptions={
                props.subscriptions[d[props.metadata.PrimaryIdAttribute]] ?? []
            }
            ...
            isSelected={
                ...
                props.selectedRecords[d[props.metadata.PrimaryIdAttribute]]
            }
        />
    );
    ...
    return (
        <div
            ...
            style={{
                ...style,
                minWidth: !props.config.fitLanesToScreenWidth
                    ? props.minWidth ?? "400px"
                    : props.lane.data.length
                    ? "auto"
                    : "20px",
                marginTop: "5px",
                marginBottom: "5px",
        ...
        >
            ...
            >
                ...
                >
                    <h5
                        title={props.lane.option.Label.UserLocalizedLabel.Label}
                        style={{
                            fontSize: "17.5px",
                            fontWeight: "normal",
                            cursor: "default",
                    ...
                    >
                        {props.lane.option.Label.UserLocalizedLabel.Label}{" "}
                        {!props.config.hideCountOnLane && (
                            <a>({props.lane.data.length})</a>
                        )}
                    </h5>
                </Card.Section>
                <Card.Section
                    styles={{ root: { overflow: "auto", padding: "0.5rem" } }}
                >
